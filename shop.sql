...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 12, 2022 lúc 08:48 AM
...
('KH008', 'Phạm Gia Phong ', 354755957, 'phong.gia60@gmail.com', 'Thanh Xuân, Hà Nội', '', NULL, NULL, NULL, NULL);
...
('admin', 'admin', 'admin', 1, NULL, 935421855, NULL, '0000-00-00', '1', 0, 1);
...
--
ALTER TABLE `tables`
  MODIFY `IdTable` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
